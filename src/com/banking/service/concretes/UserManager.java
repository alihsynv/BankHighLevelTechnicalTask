...
import com.banking.service.abstracts.UserService;
import com.banking.exceptions.BaseException;
import com.banking.entities.concretes.User;
import com.banking.exceptions.custom.InvalidLoginException;
...
import com.banking.validations.UserValidator;
...
public class UserManager implements UserService {
    ...
    public void registerUser(String fin,
                             String password,
                             String name,
                             String surname,
                             LocalDate dateOfBirth,
                             String providerCode,
                             String number) throws BaseException {
